...
public:
    ...
    void set_border_color(uint8_t red, uint8_t green, uint8_t blue, uint8_t alpha, Element_status statu = Element_status::normal);
    void get_border_color(uint8_t &red, uint8_t &green, uint8_t &blue, uint8_t &alpha, Element_status statu = Element_status::normal) const;
